...
import { PinkAlien, EnemyShip, BlueAlien } from './enemies';
...
class Game {
  ...
  play() {
    this.ship.initiate()
    let alien =  new PinkAlien(0, 0.5, this, 20);
    let blue = new BlueAlien(0, 0.25, this, 50, this.ship);
    blue.initiate(150, 0, this);
    blue.initiate(450, 0, this);
    alien.initiate(300, 0, this);
