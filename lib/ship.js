...
class Ship {
  ...
  shoot() {
    let bullet1 = new defaultBullet(-2, -30, this.stage);
    let bullet2 = new defaultBullet(2, -30, this.stage);
    let bullet3 = new defaultBullet(0, -30, this.stage);
    let bullet4 = new defaultBullet(0, -30, this.stage);
    let bullet5 = new defaultCurveBullet(0, -30, this.stage, this.ticker, 30);
    let bullet6 = new defaultCurveBullet(0, -30, this.stage, this.ticker, 99);
  ...
  playerAction() {
    ...
    if (this.keys[90] &&
      this.ticker.getTicks() % 5 === 0) this.shoot();
  }
}
