...
export function waveOne(game) {
  ...
  setTimeout(() => purple(-50, 80, 0.5, 1, 'ease2', 'multiple circles', game), 35000);
  setTimeout(() => threePink(300, -50, 0.5, 1, 'ease', 'single', game), 40000);
  setTimeout(() => threePink(300, -50, 0.5, 1, 'ease2', 'single', game), 42000);
  setTimeout(() => threePink(150, -50, 0.5, 1, 'ease3', 'single', game), 45000);
  setTimeout(() => threePink(450, -50, 0.5, 1, 'ease3', 'single', game), 45000);
  setTimeout(() => threePink(300, -50, 0.5, 1, 'ease2', 'single', game, true), 47000);
}
