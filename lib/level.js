...
function playLevel(game) {
  ...
  // setTimeout(() => threePink(300, 0, 0.5, 1, 'ease2', 'single', game), 19000);
  ...
  // setTimeout(() => purple(-50, 80, 0.5, 1, 'ease2', 'multiple circles', game), 33000);
  // setTimeout(() => threePink(300, -50, 0.5, 1, 'ease', 'single', game), 35000);
  // setTimeout(() => threePink(300, -50, 0.5, 1, 'ease2', 'single', game), 35000);
  // setTimeout(() => threePink(150, -50, 0.5, 1, 'ease3', 'single', game), 37000);
  // setTimeout(() => threePink(450, -50, 0.5, 1, 'ease3', 'single', game), 37000);
  // setTimeout(() => threePink(300, -50, 0.5, 1, 'ease2', 'single', game), 40000);
  // setTimeout(() => blue(500, 0, 0.5, 1, 'ease2', 'shotgun', game), 45000);
  // setTimeout(() => pinkDiagonal(650, 400, -5, -0.5, 'linear', 'circle', game), 48000);
  // setTimeout(() => pinkDiagonal(650, 300, 5, -0.5, 'linear', 'circle', game), 49500);
  // setTimeout(() => pinkDiagonal(-50, 400, -5, -0.5, 'linear', 'circle', game), 51000);
  // setTimeout(() => pinkDiagonal(-50, 300, 5, -0.5, 'linear', 'circle', game), 52500);
  // setTimeout(() => symmetricGreen(game), 55000);
  // setTimeout(() => blue(450, 0, 0.5, 1, 'ease', 'shotgun', game), 57000);
  // setTimeout(() => threePink(300, -50, 0.5, 1, 'ease', 'single', game), 60000);
  // setTimeout(() => threePink(300, -50, 0.5, 1, 'ease2', 'single', game), 60000);
  // setTimeout(() => threePink(150, -50, 0.5, 1, 'ease3', 'single', game), 62000);
  // setTimeout(() => threePink(450, -50, 0.5, 1, 'ease3', 'single', game), 62000);
  // setTimeout(() => threePink(300, -50, 0.5, 1, 'ease2', 'single', game), 65000);
  setTimeout(() => boss(game), 10)
}

function boss(game) {
  let boss = new Boss(0, 0, game, 50);
  boss.initiate(300, -20);
}
