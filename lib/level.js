...
export function waveOne(game) {
  ...
  setTimeout(() => threePink(300, -50, 0.5, 1, 'ease2', 'single', game, true), 40000);
}

export function waveTwo(game) {
  setTimeout(() => blue(500, 0, 0.5, 1, 'ease2', 'shotgun', game), 0);
  ...
  setTimeout(() => pinkDiagonal(-50, 400, -5, -0.5, 'linear', 'circle', game), 6000);
  setTimeout(() => pinkDiagonal(-50, 300, 5, -0.5, 'linear', 'circle', game), 7500);
  setTimeout(() => symmetricGreen(game), 10000);
  setTimeout(() => blue(450, 0, 0.5, 1, 'ease', 'shotgun', game), 15000);
  setTimeout(() => threePink(300, -50, 0.5, 1, 'ease', 'single', game), 17000);
  setTimeout(() => threePink(300, -50, 0.5, 1, 'ease2', 'single', game), 17000);
  setTimeout(() => threePink(150, -50, 0.5, 1, 'ease3', 'single', game), 19000);
  setTimeout(() => threePink(450, -50, 0.5, 1, 'ease3', 'single', game), 19000);
  setTimeout(() => purple(-50, 80, 0.5, 1, 'ease2', 'multiple circles', game), 21000);
  setTimeout(() => threePink(300, -50, 0.5, 1, 'ease2', 'single', game, true), 24000);
}
