...
export function waveTwo(game) {
  ...
  setTimeout(() => blue(450, 0, 0.5, 1, 'ease', 'shotgun', game), 12000);
  setTimeout(() => threePink(300, -50, 0.5, 1, 'ease', 'single', game), 15000);
  setTimeout(() => threePink(300, -50, 0.5, 1, 'ease2', 'single', game), 15000);
  setTimeout(() => threePink(150, -50, 0.5, 1, 'ease3', 'single', game), 17000);
  setTimeout(() => threePink(450, -50, 0.5, 1, 'ease3', 'single', game), 17000);
  setTimeout(() => threePink(300, -50, 0.5, 1, 'ease2', 'single', game, true), 20000);
}

export function bossWave(game) {
  setTimeout(() => boss(game), 0)
}

function boss(game) {
  let boss = new Boss(0, 0, game, 5000);
