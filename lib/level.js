...
export function waveThree(game) {
  ...
  setTimeout(() => threePink(300, -50, 0.5, 1, 'ease2', 'single', game, true), 8000);
}
...
export function waveFive(game) {
  ...
  setTimeout(() => purple(-50, 80, 0.5, 1, 'ease2', 'multiple circles', game), 4000);
  setTimeout(() => symmetricGreen(game), 7000);
