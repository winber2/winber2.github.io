...
export function waveOne(game) {
  ...
  setTimeout(() => blue(450, 0, 0.5, 1, 'ease', 'shotgun', game), 35000);
  setTimeout(() => threePink(300, -50, 0.5, 1, 'ease', 'single', game), 36000);
  setTimeout(() => threePink(300, -50, 0.5, 1, 'ease2', 'single', game), 36000);
  setTimeout(() => purple(-50, 80, 0.5, 1, 'ease2', 'multiple circles', game), 41000);
  setTimeout(() => threePink(150, -50, 0.5, 1, 'ease3', 'single', game), 43000);
  setTimeout(() => threePink(450, -50, 0.5, 1, 'ease3', 'single', game), 43000);
  setTimeout(() => threePink(300, -50, 0.5, 1, 'ease2', 'single', game, true), 45000);
}
...
export function waveTwo(game) {
  ...
  setTimeout(() => blue(450, 0, 0.5, 1, 'ease2', 'shotgun', game), 17000);
